...
function Renderizacao(props) {
  ...
  function cardFinanciamento(props) {
    Swal.fire({
      ...
      imageWidth: 500,
      imageHeight: 350,
      text: `Pode ser seu Apartir de 24x de R$${(
        props.carro.preco / 24
    ...
    <div className="flex flex-col items-center justify-center">
      <section className="bg-slate-100 w-11/12 flex flex-col items-center rounded-2xl shadow_image">
        <img
          ...
          alt="carro"
          className=" rounded-2xl shadow_image "
        />
        ...
        <p className="text-3xl font-semibold">
          R${" "}
          {props.carro.preco.toLocaleString("pt-br", {
        ...
        <div className="flex items-center gap-14 my-5 ">
          ...
          />
          <button
            className="bg-zinc-600 p-2 text-slate-50 border-2 border-amber-500 rounded-xl"
            onClick={() => cardFinanciamento(props)}
          >
            Financiamento
          </button>
          <p>{props.carro.ano}</p>
